...
[
  ...
  //ID'si 5 olan ürünü bulma
  const filteredid = products.filter((item)=>{
    return item.id==5
  })
  ...
  //Ürün fiyatı 30 dan büyük ve categoryIdsi 2 olmayan ürüm sayısı
  const filteredprice = products.filter((item)=>{
    return item.unitPrice>30 && item.categoryId!=2
  })
  console.log(filteredprice.length)
